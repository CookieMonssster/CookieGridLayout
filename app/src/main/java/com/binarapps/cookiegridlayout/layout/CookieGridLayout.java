  ...
  protected void onLayout(boolean b, int left, int top, int right, int bottom) {
    ...
    for (int i = 0; i < cookieDim.getCount(); i++) {
      ...
      if (availableSpace != null) {
        ...
        int endRight = cookieDim.calculateWidth(startLeft, lp.spanColumns);
        int endBottom = cookieDim.calculateHeight(startTop, lp.spanRows);
        ...
        child.layout(startLeft, startTop, endRight, endBottom);
